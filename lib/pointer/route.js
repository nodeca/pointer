 ...
 *  - prefixOptions (Object): Override keys to compose URL prefix: protocol,
...
Route.prototype.buildURL = function buildURL(params, prefixOptions) {
  ...
  var prefix   = '',
      ...
      protocol = prefixOptions.protocol || this.__prefix_protocol__,
      hostname = prefixOptions.hostname || this.__prefix_hostname__,
      port     = prefixOptions.port     || this.__prefix_port__,
      pathname = prefixOptions.pathname || this.__prefix_pathname__;
