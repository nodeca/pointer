...
//    var obj = {};
//
//    setPrefixRegExp(obj, '//example.com');
//    setPrefixRegExp(obj, 'https://example.com/foobar');
//
//    // {
//    //   'example.com': {
//    //     'https': { 'https://example.com/foobar': /^\/foobar/ },
//    //     '*':     { '//example.com': null }
//    //   }
//    // }
//
...
Pointer.prototype.addRoute = function addRoute(pattern, options) {
  ...
  if (!this.__routes__[options.prefix || '*']) {
    this.__routes__[options.prefix || '*'] = [];
  }

  this.__routes__[options.prefix || '*'].push(route);
